# 2016.11.19 19:54:25 Støední Evropa (bìžný èas)
...
def embossFilter(k = 1):
    ...
    samples.append((0.0, 0.0, 0.0))
    return samples
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\PostProcessing\FilterKernels.pyc 
