# 2016.11.19 19:47:36 Støední Evropa (bìžný èas)
...
class SiegeModeSoundNotifications(Component):
    ...
    def __onSiegeTimer(self):
        ...
        self.__siegeCallback = None
        return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\AvatarInputHandler\siege_mode_sound_notifications.pyc 
