# 2016.11.19 19:47:39 Støední Evropa (bìžný èas)
...
class SteadyVehicleMatrixCalculator(Component):
    ...
    def relinkSources(self):
        ...
        if vehicle is None:
            ...
            return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\AvatarInputHandler\AimingSystems\steady_vehicle_matrix.pyc 
