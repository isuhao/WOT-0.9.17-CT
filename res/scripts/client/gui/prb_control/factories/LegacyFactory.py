# 2016.11.19 19:49:14 Støední Evropa (bìžný èas)
...
class LegacyFactory(ControlFactory):
    ...
    def __createByPrbType(self, ctx):
        ...
        if ctx.getCtrlType() != CTRL_ENTITY_TYPE.LEGACY:
            ...
            return None
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\gui\prb_control\factories\LegacyFactory.pyc 
