# 2016.11.19 19:49:00 Støední Evropa (bìžný èas)
...
class UnitEntity(_UnitEntity):
    ...
    def _isInCoolDown(self, requestType, callback = None, coolDown = None):
        ...
        if self._cooldown.validate(requestType, coolDown):
            ...
            return True
        return False
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\gui\prb_control\entities\base\unit\entity.pyc 
