# 2016.11.19 19:51:39 Støední Evropa (bìžný èas)
...
class ToolTip(ToolTipMgrMeta):
    ...
    def __getTags(self, block_type, format_type):
        ...
        return ['', '']
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\gui\Scaleform\framework\ToolTip.pyc 
