# 2016.11.19 19:49:45 Støední Evropa (bìžný èas)
...
def createPlayer(view, acousticType):
    ...
    if acousticType in _PRESETS:
        ...
        return None
        return None
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\gui\Scaleform\daapi\view\common\settings\acoustic_presets.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2016.11.19 19:49:46 Støední Evropa (bìžný èas)
