# 2016.11.19 19:49:49 Støední Evropa (bìžný èas)
...
class RestoreTankmanDialog(_TankmanOperationDialogBase):
    ...
    def _buildVO(self):
        ...
        return {'questionText': text_styles.stats(_ms(DIALOGS.RESTORETANKMAN_PRICE)),
         ...
         'warningText': '\n\n'.join(warningTexts)}
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\gui\Scaleform\daapi\view\dialogs\TankmanOperationDialog.pyc 
