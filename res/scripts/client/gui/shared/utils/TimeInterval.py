# 2016.11.19 19:53:15 Støední Evropa (bìžný èas)
    ...
    def __invoke(self):
        ...
        if obj is not None:
            ...
            if func and callable(func):
                func()
        return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\gui\shared\utils\TimeInterval.pyc 
