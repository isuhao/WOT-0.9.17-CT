# 2016.11.19 19:47:42 Støední Evropa (bìžný èas)
...
def _niceFunctionString(f):
    if not (callable(f) or isinstance(f, types.GeneratorType) or isinstance(f, _BWCoroutineFunction)):
        ...
        return str(f)
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\bwobsolete_helpers\BWCoroutine.pyc 
