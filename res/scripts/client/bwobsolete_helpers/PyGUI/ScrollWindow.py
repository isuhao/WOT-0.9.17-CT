# 2016.11.19 19:47:49 Støední Evropa (bìžný èas)
    ...
    def handleKeyEvent(self, event):
        ...
        if not handled and down:
            ...
            if event.key in [Keys.KEY_JOYARPUSH, Keys.KEY_MIDDLEMOUSE]:
                ...
                return True
        return False
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\bwobsolete_helpers\PyGUI\ScrollWindow.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2016.11.19 19:47:50 Støední Evropa (bìžný èas)
