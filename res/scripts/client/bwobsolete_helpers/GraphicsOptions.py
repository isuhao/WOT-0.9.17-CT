# 2016.11.19 19:47:44 Støední Evropa (bìžný èas)
...
def enableOptincludeOption(value, enable):
    ...
    if changed and len(output) > 0:
        ...
        f.close()
    return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\bwobsolete_helpers\GraphicsOptions.pyc 
