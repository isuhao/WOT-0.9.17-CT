...
def dump_file(filename, head = None):
    ...
    return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\common\Lib\distutils\command\config.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2016.11.19 19:58:29 Støední Evropa (bìžný èas)
