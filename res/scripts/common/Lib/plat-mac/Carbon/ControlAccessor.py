# 2016.11.19 20:00:51 Støední Evropa (bìžný èas)
...
def GetControlData(control, part, selector):
    ...
    if type(data) == type(()) and len(data) == 1:
        data = data[0]
    return data
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\common\Lib\plat-mac\Carbon\ControlAccessor.pyc 
