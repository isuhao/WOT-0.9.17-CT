# 2016.11.19 20:00:39 Støední Evropa (bìžný èas)
...
def writepycfile(codeobject, cfile):
    ...
    fc.write(MAGIC)
    fc.close()
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\common\Lib\plat-mac\buildtools.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2016.11.19 20:00:40 Støední Evropa (bìžný èas)
