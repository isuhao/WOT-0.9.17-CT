# 2016.11.19 20:00:48 Støední Evropa (bìžný èas)
...
def test():
    ...
    pm.blit(20, 20)
    return pm
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\common\Lib\plat-mac\PixMapWrapper.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2016.11.19 20:00:49 Støední Evropa (bìžný èas)
