# 2016.11.19 20:01:16 Støední Evropa (bìžný èas)
...
class TestResult(object):
    ...
    def __repr__(self):
        return '<%s run=%i errors=%i failures=%i>' % (util.strclass(self.__class__),
         ...
         len(self.errors),
         len(self.failures))
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\common\Lib\unittest\result.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2016.11.19 20:01:17 Støední Evropa (bìžný èas)
