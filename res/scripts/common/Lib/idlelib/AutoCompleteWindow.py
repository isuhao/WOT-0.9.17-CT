# 2016.11.19 19:59:06 Støední Evropa (bìžný èas)
...
class AutoCompleteWindow:
    ...
    def hide_window(self):
        if not self.is_active():
            ...
            return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\common\Lib\idlelib\AutoCompleteWindow.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2016.11.19 19:59:07 Støední Evropa (bìžný èas)
