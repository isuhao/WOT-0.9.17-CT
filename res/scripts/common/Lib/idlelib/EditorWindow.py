# 2016.11.19 19:59:12 Støední Evropa (bìžný èas)
...
if __name__ == '__main__':
    ...
    if len(sys.argv) <= 1:
        run(_Help_dialog)
    run(_Editor_window)
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\common\Lib\idlelib\EditorWindow.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2016.11.19 19:59:14 Støední Evropa (bìžný èas)
