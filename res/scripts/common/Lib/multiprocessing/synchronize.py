# 2016.11.19 20:00:24 Støední Evropa (bìžný èas)
...
class Event(object):
    ...
    def wait(self, timeout = None):
        ...
        try:
            ...
            self._cond.release()
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\common\Lib\multiprocessing\synchronize.pyc 
