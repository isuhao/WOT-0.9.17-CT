# 2016.11.19 19:56:34 Støední Evropa (bìžný èas)
...
class LineAndFileWrapper():
    ...
    def readlines(self, size = None):
        if self._line_consumed:
            ...
            return None
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\common\Lib\httplib.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2016.11.19 19:56:35 Støední Evropa (bìžný èas)
