# 2016.11.19 19:56:44 Støední Evropa (bìžný èas)
...
def copybinary(input, output):
    ...
    while 1:
        ...
        if not line:
            break
        output.write(line)
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\common\Lib\mimetools.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2016.11.19 19:56:45 Støední Evropa (bìžný èas)
