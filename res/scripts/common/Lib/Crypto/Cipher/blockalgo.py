# 2016.11.19 19:57:59 Støední Evropa (bìžný èas)
...
class BlockAlgo:
    ...
    def decrypt_and_verify(self, ciphertext, mac_tag):
        ...
        self.verify(mac_tag)
        return pt
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\common\Lib\Crypto\Cipher\blockalgo.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2016.11.19 19:58:00 Støední Evropa (bìžný èas)
